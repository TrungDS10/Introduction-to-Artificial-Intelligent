...
X_train = X_train.str.replace('\W', ' ', regex=True)
...
#Remove all punctuation marks
X_test = X_test.str.replace('\W', ' ', regex = True)
#Change all letters to small case
...
#======Testing the NB=======
proba_table = NB.predict_proba(X_test)
precision,recall,F1 = NB.score(y_test,proba_table['predict'])
